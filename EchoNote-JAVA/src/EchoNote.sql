CREATE DATABASE IF NOT EXISTS echonote CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE echonote;
...
-- 插入用户测试数据
INSERT INTO user (id, user_name, password, name, email, is_enabled, update_time) VALUES
                                                                                      (1, '3029489598', '$2a$10$3W2cZsiLL1jCVUtyPOfILOjF9cibmseYmWglPAe1VnGyWriwgZR1y', '逐辰', '3029489598@qq.com', 1, '2025-06-22 11:02:35'),
                                                                                     (2, '123456', '$2a$10$HJusN5zCTdWrz3kq5sz4ROSlyi7WVZJyerwv7./3yNQmUviov7Dlm', '测试', '123456@qq.com', 1, '2025-06-22 11:47:20'),
                                                                                     (3, 'ADMIN', '$2a$10$8Jzu4r3XO1IezN8aMJ.ZGeI0QPg3DY/ed9KNKnU9djkmjtDLcY9Iy', '管理员', 'admin@qq.com', 1, '2025-06-21 13:30:25');
...
-- 插入胶囊测试数据
INSERT INTO capsules (user_id, title, location, description, create_time, update_time, status) VALUES
                                                                                                   (2, '上升贬低价值探讨', '饭桌', '饭桌上，父亲要求分完没吃完的饭，并说不能浪费食物，这么一点饭怎么也得把它吃完。彼时我的想法是，我确实不想吃了，这种价值的抬高是否是对我的凌驾呢？互联网上也会有提高价值亦或是贬低价值的行为，我该怎么思考这种价值标准的合理性呢？', '2025-08-24 21:02:35', '2025-08-24 21:02:35', 0),
                                                                                                   (2, '言语的场合、分寸性', '抖音评论区', '在抖音评论区上看到了一个养猫人说自己的猫猫"回咪星找麻麻了"，底下有人评论"没有咪星哦 死了就是死了 不是去找妈妈了 就是死了 嘎巴一下就死那了"', '2025-08-29 20:51:35', '2025-08-29 21:51:35', 0);
...
INSERT INTO category (user_id, name) VALUES (2, '随笔');
