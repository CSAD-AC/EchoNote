...
一个集灵感捕捉、心流创作、深度反思与逻辑博弈于一体的个人思维进化系统。
...
**即时灵感捕捉系统**
- 💡 **快速记录**：即时捕获突发的想法和灵感。
- 📍 **情境标记**：支持手动位置标记与详细情境描述。
- 😌 **情绪关联**：内置 42 种精细情绪标签，精准锚定心理状态。
- 🔄 **状态追踪**：清晰管理灵感生命周期（未处理 / 已处理）。

#### 2. ✍️ 心流写作 (Flow Writing)
**沉浸式写作体验**
- 📝 **版本管理**：完整的文档版本化控制，随时回溯。
- 🗂️ **分类整理**：高效的文档分类与归档系统。
- 💾 **自动备份**：实时自动保存，确保内容安全无忧。
- 🧘 **专注模式**：极简写作界面，屏蔽干扰，沉浸创作。

#### 3. 🧠 思维慢发酵 (Slow Fermentation)
**深度思考培养系统**
- 🕰️ **延迟回看**：24 小时强制冷却机制，重塑审视视角。
- 🤖 **AI 挑衅**：自动生成尖锐提问，激发批判性思考。
- 📈 **轨迹追踪**：可视化记录思维发展的完整路径。
- 🧩 **多维框架**：提供多角度思考模型，打破单一视角局限。

#### 4. ⚔️ 思维迷宫 (Maze of Thought)
**交互式逻辑博弈场**
- 📅 **每日挑战**：每日推送逻辑谜题与思维辩题。
- 🚩 **立场预设**：支持选择预设立场或自定义独特观点。
- 🗣️ **多轮辩论**：与 AI 进行深度交互驳斥，动态引导思考。
- 💡 **思维引导**：在博弈中挖掘逻辑盲区，深化认知层次。

---
> 🚀 **理念**：从捕捉灵感到淬炼思想，让每一次思考都更有深度。
